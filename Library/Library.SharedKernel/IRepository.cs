...
public interface IRepository<T> where T : Entity
{
    /// <summary>
    ///     Filter:
    ///     The code Expression<Func<T, bool>> filter means the caller will provide a lambda expression based on the T type,
    ...
    ///         The expression will return an ordered version of that IQueryable object.the repository is instantiated for the
    ///         Student code in the calling method might specify q => q.OrderBy(s => s.LastName) for the orderBy parameter.
    /// </summary>
